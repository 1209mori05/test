...
public class TestUserDAO {
	...
	public void select(String name,String password){
		...
		try{
			...
			if(rs.next()){
				System.out.print("名前:"+rs.getString("user_name")+" ");
				System.out.println("パスワード:"+rs.getString("password"));
			}
	...
	public void updateUserNameByUserName(String oldName,String newName){
		...
		try{
			...
			if(i>0){
				...
				System.out.println("更新:該当するデータはありませんでした");
			}
		}catch(SQLException e){
			e.printStackTrace();
		}try{
	...
	public void delete(String name){
		...
		try{
			...
			if(i>0){
				...
				System.out.println("削除:該当するデータはありませんでした");
			}
		}catch(SQLException e){
			e.printStackTrace();
		}try{
